        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Vocational <span className="text-[#7b1e1e]">Training</span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Empowering youth and marginalized communities with practical skills for sustainable livelihoods
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="bg-gradient-to-br from-[#7b1e1e]/10 to-[#5a1414]/10 p-8 sm:p-10 lg:p-12 rounded-2xl border border-[#7b1e1e]/30 backdrop-blur-sm">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  The program focuses on providing vocational training and essential skills to youth and marginalized communities. By equipping individuals with practical skills, this program aims to enhance employability, empower communities economically, and contribute to sustainable livelihoods.
                </p>

                <p className="text-base sm:text-lg text-[#7b1e1e] font-semibold mt-6">
                  We create pathways to economic independence through skill development and entrepreneurship.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden border-4 border-[#7b1e1e]/30 shadow-lg">
                <img
                  src="https://i.ibb.co/9mYvxM5S/health.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Skills We <span className="text-[#7b1e1e]">Teach</span>
            </h2>

            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Comprehensive training programs designed for real-world success
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden border-4 border-[#7b1e1e]/30 shadow-lg">
                <img
                  src="https://i.ibb.co/rRZ2XCJ0/vocational.jpg"
            ...
            >
              <div className="bg-gradient-to-br from-[#7b1e1e]/10 to-[#5a1414]/10 p-8 sm:p-10 lg:p-12 rounded-2xl border border-[#7b1e1e]/30 backdrop-blur-sm">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  We envision economically empowered communities where youth and marginalized groups have access to quality vocational training, leading to sustainable employment and entrepreneurship opportunities.
                </p>

                <p className="text-base sm:text-lg text-[#7b1e1e] font-semibold mt-6">
                  Through practical skills and job readiness, we create pathways to economic independence and community prosperity.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-r from-[#7b1e1e] to-[#5a1414] text-center text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
              Support Skills{" "}
              <span className="text-yellow-300">Development</span>
            </h2>

            <p className="text-lg sm:text-xl text-gray-100 mb-8">
              Your contribution helps us train more individuals and create sustainable livelihoods in communities.
            </p>
