        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Climate <span className="text-[#7b1e1e]">Action</span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Building climate-resilient communities through awareness, advocacy, and collective action
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="bg-gradient-to-br from-[#7b1e1e]/10 to-[#5a1414]/10 p-8 sm:p-10 lg:p-12 rounded-2xl border border-[#7b1e1e]/30 backdrop-blur-sm">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  The Magic Initiative actively engages in climate advocacy, promoting sustainable practices and raising awareness about the impacts of climate change. Through community-based actions, workshops, and awareness campaigns, the initiative fosters collective responsibility in mitigating environmental harm.
                </p>

                <p className="text-base sm:text-lg text-[#7b1e1e] font-semibold mt-6">
                  We empower communities to take action against climate change through education, advocacy, and grassroots initiatives.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden border-4 border-[#7b1e1e]/30 shadow-lg">
                <img
                  src="https://i.ibb.co/5gd7F7zm/climate3.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Our Climate <span className="text-[#7b1e1e]">Initiatives</span>
            </h2>

            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Comprehensive programs driving sustainable change in communities
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden border-4 border-[#7b1e1e]/30 shadow-lg">
                <img
                  src="https://i.ibb.co/ymN9TCsg/climate4.jpg"
            ...
            >
              <div className="bg-gradient-to-br from-[#7b1e1e]/10 to-[#5a1414]/10 p-8 sm:p-10 lg:p-12 rounded-2xl border border-[#7b1e1e]/30 backdrop-blur-sm">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  We envision climate-resilient communities where sustainable practices are the norm and every individual is empowered to take action against environmental challenges.
                </p>

                <p className="text-base sm:text-lg text-[#7b1e1e] font-semibold mt-6">
                  Together, we build a future where communities thrive in harmony with nature.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-100 mb-8">
              Your support helps us expand our climate initiatives and create lasting environmental impact in communities.
            </p>
