        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
              Women <span className="text-[#7b1e1e]">Empowerment</span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Creating opportunities for women and marginalized groups to thrive as leaders, entrepreneurs, and advocates for climate justice
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="bg-gradient-to-br from-[#7b1e1e]/10 to-[#5a1414]/10 p-8 sm:p-10 lg:p-12 rounded-2xl border border-[#7b1e1e]/30 backdrop-blur-sm">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  Creating opportunities for women and marginalized groups to thrive as leaders, entrepreneurs, and advocates for climate justice. Advancing gender equality and empowering women through education, leadership, and skills development.
                </p>

                <p className="text-base sm:text-lg text-[#7b1e1e] font-semibold mt-6">
                  We promote women's economic participation and ensure gender-responsive approaches in all climate and development initiatives.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden border-4 border-[#7b1e1e]/30 shadow-lg">
                <img
                  src="https://i.ibb.co/XrwZxQCH/women-empowerment.jpg"
      ...
      <section className="py-16 sm:py-24 bg-[#f8f5f3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Comprehensive initiatives supporting women's growth and leadership
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden border-4 border-[#7b1e1e]/30 shadow-lg">
                <img
                  src="https://i.ibb.co/cc10PCWP/vocational2.jpg"
                  alt="Women leaders"
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            >
              <div className="bg-gradient-to-br from-[#7b1e1e]/10 to-[#5a1414]/10 p-8 sm:p-10 lg:p-12 rounded-2xl border border-[#7b1e1e]/30 backdrop-blur-sm">
                ...
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                  We envision a world where women and marginalized groups have equal access to opportunities, resources, and leadership roles in all aspects of society and climate action.
                </p>

                <p className="text-base sm:text-lg text-[#7b1e1e] font-semibold mt-6">
                  Through empowerment and equality, we build resilient communities where everyone can thrive.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-r from-[#7b1e1e] to-[#5a1414] text-center text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
              Support Women{" "}
              <span className="text-yellow-300">Empowerment</span>
            </h2>

            <p className="text-lg sm:text-xl text-gray-100 mb-8">
              Your contribution helps us empower more women to become leaders, entrepreneurs, and advocates for change.
            </p>
